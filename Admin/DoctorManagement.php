...
<body>
   ...
   <?php include "navbar.php"; ?>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">doctor Page</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style=" overflow-x: auto;border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        <thead>
                                    <tr>
                                    <th>Edit</th><th>Name</th><th>Email</th><th>Mobile No</th><th>Address</th><th>Valid Medical License/Registration No</th><th>Speciality</th><th>Experience</th><th>Date</th>
                                    </tr>
                                        </thead>
                                        <tbody>
                                        </tbody>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title mt-0" id="myLargeModalLabel">Add doctor</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                    <div class="col-lg-12">
                                                        <label for="example-text-input" class="col-lg-12 col-form-label  C-Modal-Data-title text-center">Add doctor</label>
    ...
    <label for="example-text-input" class="col-sm-2 col-form-label text-right">Valid Medical License/Registration No</label>
    <div class="col-sm-10">
    <input class="form-control  " type="text" placeholder="Enter Valid Medical License/Registration No" id="validmlr"><span class="help-block custom-block-hide" id="5v"><small ></small></span>
    </div>
    </div><div class="form-group row">
    <label for="example-text-input" class="col-sm-2 col-form-label text-right">Speciality</label>
    <div class="col-sm-10">
    <input class="form-control  " type="text" placeholder="Enter Speciality" id="speciality"><span class="help-block custom-block-hide" id="6v"><small ></small></span>
    </div>
    </div><div class="form-group row">
    <label for="example-text-input" class="col-sm-2 col-form-label text-right">Experience</label>
    <div class="col-sm-10">
    <input class="form-control  " type="text" placeholder="Enter Experience" id="experience"><span class="help-block custom-block-hide" id="7v"><small ></small></span>
    </div>
    </div><div class="form-group row">
    ...
    <input class="form-control  " type="datetime-local" placeholder="Enter Date" id="doc"><span class="help-block custom-block-hide" id="8v"><small ></small></span>
                                             ...
                                             <div class="form-group row">
                                                <div class="col-md-4"> 
                                                      <button type="button" onclick="Adddoctor();" class="btn btn-primary waves-effect waves-light" style="width: 100%;">Save</button>
                                                </div>
                                                <div class="col-md-4"> 
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                    <div class="col-lg-12">
                                                        <label for="example-text-input" class="col-lg-12 col-form-label  C-Modal-Data-title text-center">Edit doctor</label>
                                           <div class="form-group row">
    ...
    <label for="example-text-input" class="col-sm-2 col-form-label text-right">Valid Medical License/Registration No</label>
    <div class="col-sm-10">
    <input class="form-control  " type="text" placeholder="Enter Valid Medical License/Registration No" id="validmlr1"><span class="help-block custom-block-hide" id="5v1"><small ></small></span>
    </div>
    </div><div class="form-group row">
    <label for="example-text-input" class="col-sm-2 col-form-label text-right">Speciality</label>
    <div class="col-sm-10">
    <input class="form-control  " type="text" placeholder="Enter Speciality" id="speciality1"><span class="help-block custom-block-hide" id="6v1"><small ></small></span>
    </div>
    </div><div class="form-group row">
    <label for="example-text-input" class="col-sm-2 col-form-label text-right">Experience</label>
    <div class="col-sm-10">
    <input class="form-control  " type="text" placeholder="Enter Experience" id="experience1"><span class="help-block custom-block-hide" id="7v1"><small ></small></span>
    </div>
    </div><div class="form-group row">
    <label for="example-text-input" class="col-sm-2 col-form-label text-right">Date</label>
    <div class="col-sm-10">
    <input class="form-control  " type="datetime-local" placeholder="Enter Date" id="doc1"><span class="help-block custom-block-hide" id="8v1"><small ></small></span>
                                             ...
                                             <div class="form-group row">
                                                <div class="col-md-4"> 
                                                      <button type="button" onclick="Updatedoctor();" class="btn btn-primary waves-effect waves-light" style="width: 100%;">Update</button>
                                                </div>
...
<script src="functions/doctor.js"></script>
